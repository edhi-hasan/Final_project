...
urlpatterns = [
    ...
    path('details_blog/<int:post_id>/', views.blog_post_detail, name='blog_detail'),
    ...
    path('update-donation-date/<int:id>/', views.update_donation_date, name='update_donation_date'),
